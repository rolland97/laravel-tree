...
final class TestPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->pages([SpikePage::class, CategoryTreePage::class, RecordingTreePage::class, AnnouncementTreePage::class, SearchSlotTreePage::class, NamedTreePage::class, CollapsedTreePage::class, ConfirmHeadingTreePage::class])
